...
\includegraphics[width=0.7\textwidth]{answerB4.jpg}
...
\includegraphics[width=0.7\textwidth]{answerB6_and.jpg}

OR function: $A + B = \overline{\overline{A + B}}
                    = \overline{\overline{A} \cdot \overline{B}}
                    = \overline{A}$ \ NAND \ $\overline{B}$

\includegraphics[width=0.7\textwidth]{answerB6_or.jpg}

NOT function: $\overline{A} = \overline{A \cdot A}$
                            = A NAND A

\includegraphics[width=0.7\textwidth]{answerB6_not.jpg}
...
\includegraphics[width=0.7\textwidth]{answerB10_nand.jpg}
...
\includegraphics[width=0.7\textwidth]{answerB14.jpg}
...
\includegraphics[width=0.7\textwidth]{answerB24.jpg}
...
\includegraphics[width=0.7\textwidth]{answerB36.jpg}
